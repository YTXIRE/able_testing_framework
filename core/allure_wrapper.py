...
from core.helpers import get_current_folder
            ...
            with StepContext(self.title.format(*f_args, **f_params), f_params):
                try:
                    ...
                    try:
                        ...
                        print('Error with allure wrapper:', ex)
                        image_path = join(get_current_folder(folder=getenv('ALLURE_DIR')), f'{uuid4()}.png')
...
def step(title: str) -> CustomStepContext:
    if callable(title):
